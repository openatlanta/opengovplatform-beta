$(document).ready(function () {
  ...
  setInterval(function(){
    ...
    if ($btn_remove.length && !$btn_populate.length){
      ...
      //add populate button
      $btn_remove.parent().append('<input class="form-submit" type=button onclick="window.location=\'' + url_string + '\'" id=edit-field-ds-file-0-filefield-populate value=Populate>')
    }   
  }, 500)
});