...
<table class="<?php print $class; ?> ds-list"<?php print $attributes; ?>>
  <?php if (!empty($title)) : ?>
    <caption><?php print $title; ?></caption>
  <?php endif; ?>
  <thead>
    <tr class="ds-list-head">
      <?php $i=0;
    ...
    <?php foreach ($rows as $count => $row): ?>
      <tr class="<?php print implode(' ', $row_classes[$count]); ?> ds-list-item">
        <?php foreach ($row as $field => $content): ?>
          <td valign="top" class="views-field views-field-<?php print $fields[$field]; ?> item " style="height:50px;">
            <?php print $content; ?>
          </td>
        <?php endforeach; ?>
      </tr>
