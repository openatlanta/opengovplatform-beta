...
<?php global $base_url;?>    
	...
	$pageURL = "http://".$_SERVER["SERVER_NAME"].$base_path. 'embed-preview/';
	$qrcode_base = libraries_get_path('qrcode');
	$node_path = drupal_get_path_alias('node/'.$node->nid);
	$qr_code_url = $base_path . $qrcode_base . "/?q=" . $pageURL .$node_path;
  ...
  <div class="add-this-options">
	...
	<div style="float:right">
	 ...
	 <a title="QR Code" href="#">
       <img src="<?php echo $base_url."/".path_to_theme();?>/images/qr-icon.png" width="16" height="13" id="qr-icon" alt="QR Code" title="View Dataset through QR Reader"  />
       	<span class="qr-alt">
       		<div class="qr-pointers"></div>
            <img src="<?php echo $qr_code_url; ?>" alt="Not Available" />
            <span class="qr-note">Scan the displayed QR code to view this page on your mobile device.</span>
       	</span>
    ...
    <div class="content">
		<div class="dataset">
            ...
            print _views_embed_view('dataset', 'block_4', $args);
  			...
  			<h2>Contact</h2><?php 
  			  print _views_embed_view('dataset', 'block_3', $args);
  			?></div>
		  </div>
