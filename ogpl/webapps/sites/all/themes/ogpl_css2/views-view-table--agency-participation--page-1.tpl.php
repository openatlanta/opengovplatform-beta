  ...
  <thead>
    <tr>
      <?php foreach ($header as $field => $label): ?>
		  ...
		  if($field=='title')
		  {
		   print '<th class="views-field views-field-' . $fields[$field] . ' ds-list-head-new-first" style="width:210px; "><h3>';
		   print $label; 
		   }
		  ...
		  {  print '<th class="views-field views-field-' . $fields[$field] . ' ds-list-head-new-last" style="text-align:center; width:85px;"><h3>';
		    print $label; }
    ...
    <?php foreach ($rows as $count => $row): ?>
      <tr class="<?php print implode(' ', $row_classes[$count]); ?> ds-list-item-new">
        <?php foreach ($row as $field => $content): ?>
            ...
            <?php 
			if($field!='title')
				print ' <td class="views-field views-field-' . $fields[$field] . ' " style="text-align:center;"><p>';	
			else 
			  print  '<td class="views-field views-field-' . $fields[$field] . ' " style="font-size:1em !important;"><p>';
			print $content; 
