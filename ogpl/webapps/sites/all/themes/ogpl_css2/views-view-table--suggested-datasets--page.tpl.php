    ...
    <tr>
      <?php foreach ($header as $field => $label): ?>
          ...
          <?php
			if($field=='counter')
			{
				print '<th class="views-field views-field-' . $fields[$field] . ' ds-list-head-new-first" style="text-align:center; ">';
				print $label; 
			}
			else if($field==='field_feedback_body_value')
			{
				print '<th class="views-field views-field-' . $fields[$field] . ' ds-list-head-new" style="width:550px; ">';
				print $label;
			}
			else if($field=='value') 
			{  
