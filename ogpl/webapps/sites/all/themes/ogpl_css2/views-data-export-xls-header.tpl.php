<html>
  ...
  <body>
	...
	if($view->name == 'agency_datasets') {
		...
		switch($catalog_type) {
			case '1': case 'catalog_type_raw_data': $catalog = 'Dataset Catalogs'; break;
			case '2': case 'catalog_type_document':$catalog = 'Document Catalogs'; break;
			case '3': case 'catalog_type_data_apps':$catalog = 'App Catalogs'; break;
			case '4': case 'catalog_type_data_tools':$catalog = 'Tool Catalogs'; break;
			case '5': case 'catalog_type_data_service': $catalog = 'Service Catalogs'; break;
		}
		?>
