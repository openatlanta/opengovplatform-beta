	...
	<div id="bodyPanel">
		<div id="outerContainer">
		  <?php include ('include/nav.tpl.php') ;?>
			<a name="mainContent" style="display: block;height: 0px;"></a>
			<div class="mid">
				<?php 
				  if ($search_filter){ 
            print '<div id="leftPanel"><div class="container">'.$search_filter.'</div></div>';
          } else { 
  				  print '<div id="leftPanel"><div class="container">
  	        <div class="block block-apachesolr_search" id="block-apachesolr_search-currentsearch">
