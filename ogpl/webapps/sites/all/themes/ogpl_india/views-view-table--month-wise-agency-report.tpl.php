...
<?php
	if($page == 1) {
		...
		print '<input type="submit" id="year_submit" value="Submit" class="form-submit" title="Submit"/></form></div>';
			global	 $base_url;
		print '<div class="download-report" style="margin-top:-65px;">Download report as :<a title="CSV Download" class="hyperlink"  href="'.$base_url.'/agency-publications/month-wise/csv"><img alt="CSV" src="'.$base_url.'/sites/all/themes/ogpl_india/images/csv.png" /></a> ' ;

		print '<a title="XLS Download" class="hyperlink"  href="'.$base_url.'/agency-publications/month-wise/xls"><img alt="XLS" src="'.$base_url.'/sites/all/themes/ogpl_india/images/xls.png" /></a>';
		print '<a style="padding-left:3px;" title="PDF Download"class="hyperlink" href="'.$base_url.'/printpdf/agency-publications/month-wise/pdf"><img alt="PDF" src="'.$base_url.'/sites/all/themes/ogpl_india/images/pdf.png" /></a></div>';
	}
...
<table class="<?php print $class; ?> header-width cBoth"<?php print $attributes; ?>>
	...
	<thead>
		<tr>
			<th class="ds-list-head-new" rowspan ="2"style=" border-right:1px solid; <?php if($page == 1) echo 'width:220px;'; ?> vertical-align:center;">Agency Name</th>
			...
			<th class="ds-list-head-new" rowspan="2" style="text-align:center; <?php if($page == 1) { echo 'border-right:1px solid; width:180px;'; } else { echo 'border-left:1px solid;'; } ?> vertical-align:center;">Total in the past 12 months</th>
		</tr>
