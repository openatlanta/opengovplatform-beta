...
if($page == 1) {
	...
	print '<div style="margin-top:-65px;" class="download-report">Download report as :<a title="CSV Download" class="hyperlink"  href="'.$base_url.'/month-wise-report-per-year/csv'.$argument.'"><img alt="CSV" src="'.$base_url.'/sites/all/themes/ogpl_india/images/csv.png" /></a> ' ;
	print '<a title="XLS Download"  class="hyperlink" href="'.$base_url.'/month-wise-report-per-year/xls'.$argument.'"><img alt="XLS" src="'.$base_url.'/sites/all/themes/ogpl_india/images/xls.png" /></a>';
	print '<a style="padding-left:3px;" title="PDF Download"  class="hyperlink" href="'.$base_url.'/printpdf/agency-publications/month-wise/month-wise-report-per-year/pdf'.$argument.'"><img alt="PDF" src="'.$base_url.'/sites/all/themes/ogpl_india/images/pdf.png" /></a></div>';	
}
?>
