...
<style type="text/css" media="all">
 ...
 @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'ogpl_india');?>/fusion_core/css/style.css?i";
  @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'ogpl_india');?>/fusion_core/css/typography.css?i";
  @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'ogpl_india');?>/fusion_core/css/superfish.css?i";
  @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'ogpl_india');?>/fusion_core/css/superfish-navbar.css?i";
  @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'ogpl_india');?>/fusion_core/css/superfish-vertical.css?i";
  @import "<?php echo $base_url.'/'.drupal_get_path('theme', 'ogpl_india');?>/fusion_core/css/grid16-fluid.css?i";
