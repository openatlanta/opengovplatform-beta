<?php 
  ...
  if($data['mode']!='print'){
    $_GET['embed'] = (!empty( $_GET['embed'])?$_GET['embed']:1);
  } else {
    $_GET['print'] = (!empty( $_GET['print'])?$_GET['print']:1);
  }
...
<?php 
	...
	<div class="embed-feature-links">
		...
		<div class="fLeft"><a href="<?php echo $base_path.$data['path']."#tabs-block";?>" target="_blank" class="embeded-link discuss">Write to Data Controller</a></div>
		<div class="cBoth"></div>
	</div>
	<?php } ?>
</div>
