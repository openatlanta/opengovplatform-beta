    ...
    <div class="inner">
        ...
        <div class="print-feedback">
            ...
            if ($user->uid && $node->type == "feedback") { ?>
                ...
                <img style="cursor: pointer;" src="<?php print $base_url; ?>/sites/all/themes/dms/printer_icon.png" width="20px" height="30px" title="Print" onclick="feedback_print('<?php print $url; ?>');" />
                <?php } ?>
